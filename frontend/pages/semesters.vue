<template>
    <div class="flex flex-col min-h-full gap-3 p-3 sm:p-7 lg:py-10 lg:gap-5 bg-gray-50">
        ...
        <div class="flex flex-col gap-2 lg:flex-row">
            <SemesterAdd class="grow-[3] lg:basis-1"></SemesterAdd>
            <div class="grow-[4] h-auto border rounded p-3 text-sm lg:basis-1">
        ...
        <div class="flex flex-col gap-2">
            <div class="w-full h-10 lg:w-64">
                <input placeholder="搜尋學期名稱" class="px-5 text-xs w-full h-full rounded"
                @change=""/>
            </div>
...
<script setup lang="ts">
    ...
    import { SemesterPaginator } from '~/composables/api/semester';

    const semesterPaginator = new SemesterPaginator();
