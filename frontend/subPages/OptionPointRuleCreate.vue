            ...
            <div class="flex justify-center w-full gap-2">
                <div class="flex flex-col justify-center w-full gap-0.5">
                    ...
                    <div class="flex-1 text-black text-xs">
                        <Input name="code" placeholder="請輸入編號" class="w-full rounded"/>
                    </div>
                </div>
                <div class="flex flex-col justify-center w-full gap-0.5">
                    <div class="flex gap-0.5 shrink-0 text-white">
                    ...
                    <div class="flex-1 text-black text-xs">
                        <Input name="point" placeholder="請輸入點數" class="w-full rounded"/>
                    </div>
                </div>
            </div>
            <div class="flex flex-col justify-center w-full gap-0.5">
                ...
                <div class="h-full w-full text-black text-xs">
                    <TextArea name="reason" placeholder="請輸入理由" class="w-full rounded h-full min-h-[80px] max-h-[160px]"/>
                </div>
            </div>
        </form>
